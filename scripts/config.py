...
AFFILIATION_MAX_PAPERS = int(os.environ.get("AFFILIATION_MAX_PAPERS") or min(MAX_PAPER_NUM, 15))
AFFILIATION_MAX_LLM_PAPERS = int(os.environ.get("AFFILIATION_MAX_LLM_PAPERS") or 3)
